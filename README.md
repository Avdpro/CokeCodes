...
- **Same experience**: CokeCodes' tool and applications works just as good as similar tools run in native. They launch in a blink, and run smoothly the in browsers.  Especially comparing to node like runtimes, browsers' Javascript VM can be even better.   
...
## Incomming more
This version of CokeCodes is just a concept preview. So I do not suggest to use CokeCodes as real development tool for now. More features are incomming, check the **Roadmap** below and stay tuned!
...
If you like **work in browser**, have ideas to improve, welcom to contact at: pxavdpro@gmail.com.
